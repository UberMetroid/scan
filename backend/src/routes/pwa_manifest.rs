...
const FALLBACK_DESCRIPTION: &str = "An orbital hazard sector scanner";
...
mod tests {
    ...
    fn fallback_includes_runtime_site_title() {
        let v = fallback_manifest("Scan Deluxe");
        assert_eq!(v["name"], "Scan Deluxe");
        assert_eq!(v["short_name"], "Scan Deluxe");
